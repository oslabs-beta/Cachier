            ...
            <div className='mb-12 lg:mb-0 pr-12'>
              ...
              >
                ...
                <p className='text-gray-500 mb-6 pb-4 lg:pb-0'>
                  ...
                  data. With GraphQL, you can specify what data you want to
                  request from your API. You will get back exactly what you
                  need, nothing more and nothing less. GraphQL queries always
                ...
                <p className='text-gray-500 mb-0'>
                  The RESTful APIs use the URL as the global unique identifier
                  which can be leveraged to build a cache. Unlike GraphQL, the
                  POST HTTP method is used to perform queries and there are no
                  URL-like endpoints making caching GraphQL queries difficult.
                  <br></br>
                  <br></br>
                  Cachier stores queries and the response in in-memory cache,
                  with this future queries will cause Cachier to check for the
                  request in the in-memory cache and return the result without
