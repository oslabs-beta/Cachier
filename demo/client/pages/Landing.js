      ...
      <div className="carousel w-full">
        <div id="slide1" className="carousel-item relative w-full">
          <div className='imageContainer'>
            <img src={FastIcon} alt="fast icon" className="w-full" style={{width: "175px", height: "175px"}}/>
        ...
        <div id="slide2" className="carousel-item relative w-full">
          <div className='imageContainer'>
            <img src={memoryIcon} alt="memory icon" className="w-full"style={{width: "175px", height: "175px"}}/>
        ...
        <div id="slide3" className="carousel-item relative w-full">
          <div className='imageContainer'>
            <img src={customizableIcon} alt="customizable icon" className="w-full" style={{width: "175px", height: "175px"}}/>
        ...
        <div id="slide4" className="carousel-item relative w-full">
          <div className='imageContainer'>
            <img src={demoIcon} alt="demo icon" className="w-full" style={{width: "175px", height: "175px"}}/>
