...
function Cachier(endpoint, capacity, groupSize, redisClient = null) {
  ...
  return async function checkCache(req, res, next) {
    ...
    if (redisClient) {
      ...
      valueFromCache = cachierCache[cacheKey];
    }
        ...
        .then((data) => {
          ...
          if (!isMutation) {
            ...
            redisClient
              ...
              : (cachierCache[cacheKey] = JSON.stringify(data));
            ...
            if (queue.length > capacity) {
              ...
              redisClient
                ...
                : delete cachierCache[removedQueryKey];
